...
def humour_composition(paths,translate):
    ...
    messages=[
        {"role": "system", "content": "Please generate a Chinese joke based on the analysis (only output the final joke): "},
...
with open('/data/home/ysu132/HTDM/qwen0.5b/test1.json', 'w',encoding='utf-8') as f1:
