...
input_topic_file = '/data/home/ysu132/HTDM/qwen14b/Data_mining/Mining_data_consistency/background.json'
input_angle_file = '/data/home/ysu132/HTDM/qwen14b/Data_mining/Mining_data_consistency/angle.json'
input_punchline_file = '/data/home/ysu132/HTDM/qwen14b/Data_mining/Mining_data_consistency/punchline.json'
output_file = '/data/home/ysu132/HTDM/qwen14b/humour_consistency.json'
...
for i in tqdm(range(len(humour_array))):
    ...
    for _ in range(num_samples):
        messages = [
                    {"role": "system", "content": "Given the following knowledge, translate the following joke from English into Chinese. (Please only output the translation)"},
