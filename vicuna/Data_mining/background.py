...
for i in tqdm(range(300)):
    ...
    messages = f"The topic is the news item that the joke is based on. Use a few words to describe the topics of the following input sentence. \n Input: {joke}\n" + "Topics:"
    ...
    temp = {"ID":i,"joke": joke, "topics": gen_text}
    res.append(temp)
